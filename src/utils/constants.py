...
# Default limits
DEFAULT_CLAUDE_TIMEOUT_SECONDS = 3600  # 1 hour — was 300 (5 min)
DEFAULT_CLAUDE_MAX_TURNS = 200  # was 10 — agentic tasks need many turns
DEFAULT_CLAUDE_MAX_COST_PER_USER = 100.0  # was 10.0
DEFAULT_CLAUDE_MAX_COST_PER_REQUEST = 50.0  # was 5.0
